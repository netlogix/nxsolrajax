...
final class SortingTest extends UnitTestCase
{
    ...
    public function itCanBeSerializedToJson(): void
    {
        ...
        $searchUriBuilder = $this->createMock(SearchUriBuilder::class);
    ...
    public function generateRemoveSortingUri(): void
    {
        ...
        $searchUriBuilder
            ->expects($this->once())
            ->method('getRemoveSortingUri')
            ->with(previousSearchRequest: self::isInstanceOf(SearchRequest::class));
