...
call_user_func(function () {
    ...
    $GLOBALS['TYPO3_CONF_VARS']['SYS']['Objects'][\ApacheSolrForTypo3\Solr\Domain\Search\ResultSet\Facets\RangeBased\NumericRange\NumericRangeFacet::class]['className'] = \Netlogix\Nxsolrajax\Domain\Search\ResultSet\Facets\RangeBased\NumericRange\NumericRangeFacet::class;
