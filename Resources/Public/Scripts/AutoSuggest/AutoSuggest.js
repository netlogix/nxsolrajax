...
(function(window, angular, undefined) {
	...
	module.controller('AutoSuggestCtrl', AutoSuggestCtrl);
	AutoSuggestCtrl.$inject = ['$http', 'netlogix.solrajax.autosuggest.targetPage', 'netlogix.solrajax.autosuggest.suggestUrl'];
	function AutoSuggestCtrl($http, targetPage, suggestUrl) {
		var self = this;
