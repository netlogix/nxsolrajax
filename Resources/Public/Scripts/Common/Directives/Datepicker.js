(function (window, angular, undefined) {
	...
	/**
	 * Be careful when updating datepicker.
	 * Add dynamic template urls!
	 */
	...
	angular.module('ui.bootstrap.datepicker', ['ui.bootstrap.position'])
		...
		.value('ui.bootstrap.datepicker.daypicker.templateUrl', 'typo3conf/ext/nxsolrajax/Resources/Public/Templates/Datepicker/Day.html')
		.directive('daypicker', ['ui.bootstrap.datepicker.daypicker.templateUrl', 'dateFilter', function (templateUrl, dateFilter) {
			return {
				restrict: 'EA',
				replace: true,
		...
		.value('ui.bootstrap.datepicker.monthpicker.templateUrl', 'typo3conf/ext/nxsolrajax/Resources/Public/Templates/Datepicker/Month.html')
		.directive('monthpicker', ['ui.bootstrap.datepicker.monthpicker.templateUrl', 'dateFilter', function (templateUrl, dateFilter) {
			return {
				restrict: 'EA',
				replace: true,
				templateUrl: templateUrl,
		...
		.value('ui.bootstrap.datepicker.yearpicker.templateUrl', 'typo3conf/ext/nxsolrajax/Resources/Public/Templates/Datepicker/Year.html')
		.directive('yearpicker', ['ui.bootstrap.datepicker.yearpicker.templateUrl', 'dateFilter', function (templateUrl, dateFilter) {
			return {
				restrict: 'EA',
				replace: true,
				templateUrl: templateUrl,
		...
		.value('ui.bootstrap.datepicker.datepicker.templateUrl', 'typo3conf/ext/nxsolrajax/Resources/Public/Templates/Datepicker/Datepicker.html')
		.directive('datepicker', ['ui.bootstrap.datepicker.datepicker.templateUrl', function (templateUrl) {
			return {
				restrict: 'EA',
				replace: true,
				templateUrl: templateUrl,
		...
		.value('ui.bootstrap.datepicker.datepickerPopupWrap.templateUrl', 'typo3conf/ext/nxsolrajax/Resources/Public/Templates/Datepicker/Popup.html')
		.directive('datepickerPopupWrap', ['ui.bootstrap.datepicker.datepickerPopupWrap.templateUrl', function (templateUrl) {
			return {
				restrict: 'EA',
				replace: true,
				transclude: true,
